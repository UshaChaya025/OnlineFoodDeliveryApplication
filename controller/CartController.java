...
public class CartController {
	...
	public FoodCartDto addItemToCart(@PathVariable("cartId") String cartId, @RequestBody ItemDto item) {
	...
	public FoodCartDto increaseQuantity(@PathVariable("cartId") String cartId,@PathVariable("itemId") String itemId, @PathVariable("qty") int quantity) {
	return cartService.increaseQuantity(cartId, itemId, quantity);
	}
	
	@PutMapping("/reducequantity/{cartId}/{itemId}/{qty}")
	public FoodCartDto reduceQuantity(@PathVariable("cartId") String cartId,@PathVariable("itemId") String itemId, @PathVariable("qty") int quantity) {
